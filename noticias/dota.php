...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/dotacss.css"/>
    </head>
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="menuDesplegableJugadores">
                            ...
                            $sql = 'SELECT nombre_jugador FROM jugador JOIN equipo ON equipo=id_equipo WHERE videojuego = ' . 10;
        ...
        <div class="parallax">
            ...
            <div class="jumbotron">
                <h1 class="display-4">DOTA 2</h1>
                <p class="lead">MOBA con interfaz 3D, ¿te atreves?</p>
                <!--<hr class="my-4">
            ...
            <div id="wrapper">
                <section>
                    ...
                    <article id="partidos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT * FROM partido WHERE fecha_inicio > NOW() AND videojuego = 'dota'";
                                $result = $conn->query($sql);
                    ...
                    <article id="torneos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT nombre_torneo FROM torneo JOIN partido ON partido=id_partido WHERE fecha_inicio > NOW() AND videojuego = 'dota'";
                                $result = $conn->query($sql);
                    ...
                    <article id="equipos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT * FROM equipo WHERE videojuego =" . 10;
                                $result = $conn->query($sql);
                ...
                $sql = "SELECT * FROM noticia WHERE videojuego = 'dota'";
                $result = $conn->query($sql);
                ...
                <aside id="formularioComentarios">
                    ...
                    <form id="formComments" method="post" action="../archivos_php/comentarios.php">
                        ...
                        <input type="hidden" name="videojuego" value="dota"/>
                        <p id="info"></p>
                ...
                <?php
                $sql = "SELECT * FROM comentario WHERE videojuego = 'dota'";
                $result = $conn->query($sql);
