...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/overwatchcss.css"/>
    </head>
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="menuDesplegableJugadores">
                            ...
                            $sql = 'SELECT nombre_jugador FROM jugador JOIN equipo ON equipo=id_equipo WHERE videojuego = ' . 2;
                        ...
                        <div class="dropdown-menu" aria-labelledby="menuDesplegableEquipos">
                            <form method="post" action="../archivos_php/admin.php" class="dropdown-menu p-4" id="menu_admin">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="id" class="form-control" name="id_admin" placeholder="NNNNN" required>
                                </div>
                                <div class="form-group">
                                    <label for="pass">Contraseña</label>
                                    <input type="password" id="pass" class="form-control" name="pass_admin" placeholder="*****" required>
                                </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="menuDesplegableEquipos">
                            <form id="menu_registro" method="post" action="../archivos_php/login.php" class="dropdown-menu p-4">                               
                                <div class="form-group">
                                    ...
                                    <input type="text" id="user_registro" class="form-control" name="user_registro" placeholder="usuario" required>
                                </div>
                                <div class="form-group">
                                    <label for="pass_registro">Contraseña</label>
                                    <input type="password" id="pass_registro" class="form-control" name="pass_registro" placeholder="*****" required>
                                </div>
        ...
        <div class="parallax">
            ...
            <div class="jumbotron">
                <h1 class="display-4">Overwatch</h1>
                <p class="lead">La combinación perfecta entre MOBA y Shooter.</p>
                <!--<hr class="my-4">
            ...
            <div id="wrapper">
                <section>
                    ...
                    <article id="partidos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT * FROM partido WHERE fecha_inicio > NOW() AND videojuego = 'overwatch'";
                                $result = $conn->query($sql);
                    ...
                    <article id="torneos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT nombre_torneo FROM torneo JOIN partido ON partido=id_partido WHERE fecha_inicio > NOW() AND videojuego = 'overwatch'";
                                $result = $conn->query($sql);
                    ...
                    <article id="equipos">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <?php
                                $sql = "SELECT * FROM equipo WHERE videojuego =" . 2;
                                $result = $conn->query($sql);
                ...
                <main>
                    ...
                    <div class="informacion" id="descripcion">
                        <?php
                        $sql = "SELECT * FROM videojuego WHERE nombre_videojuego = 'overwatch'";
                        $result = $conn->query($sql);
                ...
                $sql = "SELECT * FROM noticia WHERE videojuego = 'overwatch'";
                $result = $conn->query($sql);
                ...
                <aside id="formularioComentarios">
                    ...
                    <form id="formComments" method="post" action="../archivos_php/comentarios.php">
                        ...
                        <input type="hidden" name="videojuego" value="overwatch"/>
                        <p id="info"></p>
                ...
                <?php
                $sql = "SELECT * FROM comentario WHERE videojuego = 'overwatch'";
                $result = $conn->query($sql);
